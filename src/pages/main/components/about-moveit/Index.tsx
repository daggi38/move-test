...
import { aboutPageEntertainmentTitle, aboutPageFitnessDescription, aboutPageFitnessTitle } from "../../../../common/app-strings";
    ...
    <div className="mt-10 p-5 md:p-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10">
        <div className="text-light-grey text-center md:text-left">
          <div className="text-[32px] lg:text-[48px] font-Montserrat">
            <p>{aboutPageFitnessTitle}.</p>
            <p> Get Strong</p>
          </div>
          <p className="mt-3 font-raleway text-sm md:text-base">
            {aboutPageFitnessDescription}
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10 mt-20">
        <div className="text-light-grey text-center md:text-left">
          <div className="text-[32px] lg:text-[48px] font-Montserrat">
            <p>{aboutPageEntertainmentTitle}</p>
